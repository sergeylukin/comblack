...
if( ! is_admin() )
{
	add_action( 'bbp_enqueue_scripts', 'avia_bbpress_register_assets', 15 );
}
...
if( ! function_exists( 'avia_bbpress_before_page_in_footer_compile' ) )
{
	...
	function avia_bbpress_before_page_in_footer_compile( WP_Post $footer_page, $post_id )
	{
		...
		/**
		 * https://kriesi.at/support/topic/bbpress-enfold-custom-footer-issue/#post-1195677
		 *
		 * @since 4.7.4.1
		 */
