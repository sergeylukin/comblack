		...
		public function handler_special_page_message( array $params )
		{
			...
			if( $maintenance_page == $id )
			{
				if( true === $this->get_custom_page_object( 'maintenance', '', 'option_set' ) )
				{
					...
					$visibiity = __( 'If you are NOT in maintenance mode, this page cannot be accessed by the general public in your frontend. Logged in users, who are able to edit this page, can see it for developping purpose.', 'avia_framework' );
				}
				else
				{
