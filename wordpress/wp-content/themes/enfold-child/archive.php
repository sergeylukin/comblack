	 ...
	 */
	 get_header();
		...
		if(avia_get_option('frontpage') && $blogpage_id = avia_get_option('blogpage'))
		{
	 	...
	 	if($showheader)
	 	{
			echo avia_title(array('title' => avia_which_archive(),'heading'=>'span', 'link' => false));
		}
...
global $wp_query;
	...
	var_dump(is_post_type_archive( ));
						...
						if( is_post_type_archive('careers') ){
							...
							get_template_part( 'includes/careers', 'categories' );
							
							/*
							if (category_has_parent($category->term_id)){
								get_template_part( 'includes/books', 'subcategories' );
							}else{
								get_template_part( 'includes/books', 'categories' );
							}*/
						}else {
