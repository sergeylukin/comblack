...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Check if you want to have additional options to qualify rel attribute of links (nofollow, sponsored, ugc) in ALB elements (since 4.8.6.3 this option replaces theme support &quot;avia_rel_nofollow_for_links&quot; - please remove it - will be deprecated in a future version)', 'avia_framework' ),
