...
$decoration = array(
				...
				__( 'Line Trough', 'avia_framework' )	=> 'line-through !important'
			);
...
$advanced['headings_all'] = array(
	...
	"name"			=> __( 'All Headings', 'avia_framework' ) . ' (H1-H6)',
...
$advanced['main_menu_icon'] = array(
	...
	"edit"			=> array(
								...
								'menu_bg_hover' 	=> array('type' => 'colorpicker', 'name'=> __("Menu Hover BG",'avia_framework')),
                						'color_hover' 		=> array('type' => 'colorpicker', 'name'=> __("Font Hover Color",'avia_framework')),
								'border_color' 		=> array('type' => 'colorpicker', 'name'=> __("Border Color",'avia_framework')),
...
$advanced['breadcrumb'] = array(
    ...
    "name"			=> __( 'Breadcrumbs', 'avia_framework' ),
    "group" 		=> __( "Misc", 'avia_framework' ),
...
$advanced['widget_links'] = array(
    ...
    "name"			=> __( 'Widget Links', 'avia_framework' ),
    "group" 		=> __( "Misc", 'avia_framework' ),
...
$advanced['slideshow_titles'] = array(
	...
	"name"			=> __( 'Slideshow titles', 'avia_framework' ),
	"group" 		=> __( "Misc", 'avia_framework' ),
...
$advanced['slideshow_caption'] = array(
	...
	"name"			=> __( 'Slideshow caption', 'avia_framework' ),
	"group" 		=> __( "Misc", 'avia_framework' ),
...
$advanced['slideshow_button'] = array(
	...
	"name"			=> __( 'Slideshow button', 'avia_framework' ),
	"group" 		=> __( "Misc", 'avia_framework' ),
...
$advanced['cookie_consent_button'] = array(
    ...
    "name"			=> __( 'Cookie Consent Accept Settings Button', 'avia_framework' ),
    "group" 		=> __( "Cookie Consent Bar", 'avia_framework' ),
...
$advanced['cookie_consent_all_button'] = array(
    ...
    "name"			=> __( 'Cookie Consent Accept All Cookies Button', 'avia_framework' ),
    "group" 		=> __( "Cookie Consent Bar", 'avia_framework' ),
...
$advanced['cookie_consent_no_coolies_button'] = array(
    ...
    "name"			=> __( 'Cookie Consent Do Not Accept Cookies Button', 'avia_framework' ),
    "group" 		=> __( "Cookie Consent Bar", 'avia_framework' ),
...
$advanced['cookie_consent_modal_window_button'] = array(
    ...
    "name"			=> __( 'Cookie Consent Open Modal Window Button', 'avia_framework' ),
    "group" 		=> __( "Cookie Consent Bar", 'avia_framework' ),
...
$advanced['cookie_consent_link_button'] = array(
    ...
    "name"			=> __( 'Cookie Consent Link Button', 'avia_framework' ),
    "group" 		=> __( "Cookie Consent Bar", 'avia_framework' ),
...
$advanced['cookie_consent_extra_button'] = array(
    ...
    "name"			=> __( 'Cookie Consent Extra Button', 'avia_framework' ),
    "group" 		=> __( "Cookie Consent Bar", 'avia_framework' ),
