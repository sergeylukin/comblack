...
//update_option( "Enfold_version", "4.8" ); // for testing
...
add_action( 'ava_trigger_updates', 'avia_update_4_8_4_1', 21, 2 );

function avia_update_4_8_4_1( $prev_version, $new_version )
{
	//if the previous theme version is equal or bigger to 4.8.4.1 we don't need to update
