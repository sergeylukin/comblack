...
//			}
         ...
         */
		function render_single_element( array $element )
		{
...
//					}
		 ...
		 */
		function checkbox( array $element )
		{
			$output = '';
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
        function imgselect( array $element )
        {
            $output = '';
            $counter = 1;
		 ...
		 * @return string $output the string returned contains the html code generated within the method
		 */
		function textarea( array $element )
		{
			$output  = '';
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
		function link_controller( array $element )
		{
			$output  = '';
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
		function upload_gallery( array $element )
		{
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
		function colorpicker( array $element )
		{
		...
		function file_upload( array $element )
		{
...
//						'value_field'			=> 'term_id',
		...
		function select_sidebar( array $element )
		{
			$save_as = array();
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
		function visual_group_start( array $element )
		{
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
		function heading( array $element )
		{
			$extraclass = $required = '';
			if( isset( $element['required'] ) && ! empty( $element['required'] ) )
			{
         ...
         */
		function plugin_check( array $element )
		{
