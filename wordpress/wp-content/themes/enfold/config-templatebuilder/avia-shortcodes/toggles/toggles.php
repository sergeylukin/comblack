	...
	class avia_sc_toggle extends aviaShortcodeTemplate
	{
		...
		protected function get_element_styles( array $args )
		{
			...
			$selectors = array(
						...
						'toggle-icon-inner'	=> "#top .togglecontainer.{$element_id} p.toggler .toggle_icon > span",
						'toggle-icon-current'	=> "#top .togglecontainer.{$element_id} p.toggler.activeTitle .toggle_icon, #top .togglecontainer.{$element_id} p.toggler.activeTitle .toggle_icon > span",
