...
class JobAreaEntityController extends BaseController
{
	...
	public function register()
	{
		...
		$this->area_callbacks = new AreaCallbacks();
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'careerist_plugin_areas',
				'option_name' => 'careerist_plugin_area',
				'callback' => array( $this->area_callbacks, 'areaSanitize' )
			)
		);
	...
	public function setSections()
	{
		$args = array(
			array(
				'id' => 'careerist_area_index',
				'title' => 'Job area',
				'callback' => array( $this->area_callbacks, 'areaSectionManager' ),
				'page' => 'careerist_area'
			)
		);
	...
	public function setFields()
	{
		$args = array(
			array(
				'id' => 'name',
				'title' => 'Name',
				'callback' => array( $this->area_callbacks, 'textField' ),
				'page' => 'careerist_area',
				'section' => 'careerist_area_index',
				'args' => array(
					'option_name' => 'careerist_plugin_area',
					'label_for' => 'name',
			...
			array(
				'id' => 'public',
				'title' => 'Public',
				'callback' => array( $this->area_callbacks, 'checkboxField' ),
				'page' => 'careerist_area',
				'section' => 'careerist_area_index',
				'args' => array(
					'option_name' => 'careerist_plugin_area',
	...
	{
		$options = get_option( 'careerist_plugin_area' ) ?: array();
