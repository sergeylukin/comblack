...
?>
        ...
        <section>
          <h2>Add/Edit</h2>
				...
				<section>
          <h2>Export</h2>
					<a href="<?php echo add_query_arg(['action' => 'careerist_export_categories'], admin_url('admin-ajax.php')) ?>">Generate CSV export</a>
				</section>
  </div>
</div>
