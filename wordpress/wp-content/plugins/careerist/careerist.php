...
define('CAREERIST_PLUGIN_VERSION', '1.2.0');
...
register_activation_hook( __FILE__, array($App['CareeristPlugin'], 'activate') );
register_deactivation_hook( __FILE__, array($App['CareeristPlugin'], 'deactivate') );
