<?php
/*
Plugin Name: uPress Object cache
...
// can use this to guarantee uniqueness for the keys generated by this object cache
        if (!defined('WP_CACHE_KEY_SALT'))
            define('WP_CACHE_KEY_SALT', AUTH_SALT);
        ...
        {
            global $wp_object_cache;
            #   echo "\n".'<!-- Performance optimized by uPress Super cache. Learn more: http://www.upress.co.il -->';
        ...
        class WP_Object_Cache
        {
            ...
            function key($key, $group)
            {
                ...
                return $_SERVER['HTTP_HOST'] . "_" . preg_replace('/\s+/', '', '' . "$prefix$group:$key");
            }
